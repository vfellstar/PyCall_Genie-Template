...
# !!! Main.UserApp is configured as an alias for Main.CognitiveSearchApp and you might encounter it in some tests
using Main.CognitiveSearchApp, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "CognitiveSearchApp tests" begin
  @includetests ARGS
end
